...
void TrD3D12Mesh::Bind(ID3D12GraphicsCommandList* commandList) const
{
...
void TrD3D12Mesh::Draw(ID3D12GraphicsCommandList* commandList, UINT instanceCount) const
{
