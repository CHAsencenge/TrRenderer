...
void TrDescriptorHeap::Initialize(
    ID3D12Device* device,
...
TrDescriptorAllocation TrDescriptorHeap::Allocate()
{
    ...
    TrDescriptorAllocation allocation;
...
D3D12_CPU_DESCRIPTOR_HANDLE TrDescriptorHeap::GetCpuHandle(UINT index) const
{
...
D3D12_GPU_DESCRIPTOR_HANDLE TrDescriptorHeap::GetGpuHandle(UINT index) const
{
    if(!mShaderVisible)
    {
