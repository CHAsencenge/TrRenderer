...
TrD3D12UploadContext::~TrD3D12UploadContext()
{
...
void TrD3D12UploadContext::Initialize(ID3D12Device* device)
{
    if(device == nullptr)
    {
...
void TrD3D12UploadContext::UploadStaticBuffer(
...
void TrD3D12UploadContext::ExecuteAndWait(ID3D12CommandQueue* commandQueue)
{
