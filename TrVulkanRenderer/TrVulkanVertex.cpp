...
VkVertexInputBindingDescription TrVulkanVertex3DBase::GetBindingDescription()
{
    VkVertexInputBindingDescription bindingDescription = {};
    bindingDescription.binding = 0; // the binding number that this structure describes
    bindingDescription.stride = sizeof(TrVulkanVertex3DBase);
    bindingDescription.inputRate = VK_VERTEX_INPUT_RATE_VERTEX;

    return bindingDescription;
}

std::array<VkVertexInputAttributeDescription, 2> TrVulkanVertex3DBase::GetAttributeDescriptions()
{
    std::array<VkVertexInputAttributeDescription, 2> attributeDescriptions = {};
    ...
    attributeDescriptions[0].offset = offsetof(TrVulkanVertex3DBase, mPos);
...
VkVertexInputBindingDescription TrVulkanVertex3DTex::GetBindingDescription()
{
    VkVertexInputBindingDescription bindingDescription = {};
    bindingDescription.binding = 0; // the binding number that this structure describes
    bindingDescription.stride = sizeof(TrVulkanVertex3DTex);
    bindingDescription.inputRate = VK_VERTEX_INPUT_RATE_VERTEX;

    return bindingDescription;
}

std::array<VkVertexInputAttributeDescription, 3> TrVulkanVertex3DTex::GetAttributeDescriptions()
{
    std::array<VkVertexInputAttributeDescription, 3> attributeDescriptions = {};
    ...
    attributeDescriptions[0].location = 0; // shader input location number for this attribute
    attributeDescriptions[0].format = VK_FORMAT_R32G32B32_SFLOAT;
    attributeDescriptions[0].offset = offsetof(TrVulkanVertex3DTex, mPos);

    attributeDescriptions[1].binding = 0;
    attributeDescriptions[1].location = 1;
    attributeDescriptions[1].format = VK_FORMAT_R32G32B32_SFLOAT;
    attributeDescriptions[1].offset = offsetof(TrVulkanVertex3DTex, mColor);

    attributeDescriptions[2].binding = 0;
    attributeDescriptions[2].location = 2;
    attributeDescriptions[2].format = VK_FORMAT_R32G32_SFLOAT;
    attributeDescriptions[2].offset = offsetof(TrVulkanVertex3DTex, mTexCoord);

    return attributeDescriptions;
}

VkVertexInputBindingDescription TrVulkanVertexRaster::GetBindingDescription()
{
    VkVertexInputBindingDescription bindingDescription = {};
    bindingDescription.binding = 0; // the binding number that this structure describes
    bindingDescription.stride = sizeof(TrVulkanVertexRaster);
    bindingDescription.inputRate = VK_VERTEX_INPUT_RATE_VERTEX;

    return bindingDescription;
}

std::array<VkVertexInputAttributeDescription, 4> TrVulkanVertexRaster::GetAttributeDescriptions()
{
    ...
    attributeDescriptions[0].location = 0; // shader input location number for this attribute
    attributeDescriptions[0].format = VK_FORMAT_R32G32B32_SFLOAT;
    attributeDescriptions[0].offset = offsetof(TrVulkanVertexRaster, mPos);

    attributeDescriptions[1].binding = 0;
    attributeDescriptions[1].location = 1;
    attributeDescriptions[1].format = VK_FORMAT_R32G32B32_SFLOAT;
    attributeDescriptions[1].offset = offsetof(TrVulkanVertexRaster, mColor);

    attributeDescriptions[2].binding = 0;
    attributeDescriptions[2].location = 2;
    attributeDescriptions[2].format = VK_FORMAT_R32G32_SFLOAT;
    attributeDescriptions[2].offset = offsetof(TrVulkanVertexRaster, mTexCoord);

    attributeDescriptions[3].binding = 0;
    attributeDescriptions[3].location = 3;
    attributeDescriptions[3].format = VK_FORMAT_R32G32B32_SFLOAT;
    attributeDescriptions[3].offset = offsetof(TrVulkanVertexRaster, mNrm);
